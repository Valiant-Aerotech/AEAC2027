-- STUDY COPY. Inert. Live path: hardware/vion/lua/throttle_two.lua — bench test only.
-- Learn: `or 1500` on the kill channel is the polarity bug. Missing RC looked like a kill.
