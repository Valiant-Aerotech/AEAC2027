"""Georeferenced satellite mosaic, used by the GCS map and the SITL window."""
...
from valiant.core.geo import SitlHome, lat_lon_to_tile_fraction


@dataclass(frozen=True)
class GeoMapAsset:
    """Satellite mosaic aligned to a LOCAL NED origin."""
    ...
    @classmethod
    def load(cls, manifest_path: str | Path) -> GeoMapAsset | None:
    ...
    @classmethod
    def default(cls) -> GeoMapAsset | None:
