"""Shared drawing primitives for the GCS map, HUD overlays and the SITL window."""
...
C_BOUNDARY = (255, 170, 90)

STATE_COLORS = {
    "LAPS": (255, 170, 60),
    "TRANSIT": (160, 200, 255),
    "SWEEPING": (80, 200, 255),
    "IDENTIFYING": (200, 160, 255),
    "SEARCHING": (255, 170, 60),
    "APPROACHING": (80, 200, 255),
    "AIMING": (100, 230, 150),
    "ATTACHING": (80, 120, 255),
    "STANDOFF": (255, 140, 140),
    "TRACKING": (140, 220, 255),
    "COLLECTING": (200, 160, 255),
