...
Tracks A1-A7, B1-B8, C1-C7, C9, D1-D9 (code), E1, E5-E6, E7-E9, F1-F4, F6
...
| Depth sensor field validation (ArduCam + H-Flow) | #26 | D | high | metric-recon | **partial**; 3D recon + cal tools; hardware pass pending |
| FOV / depth calibration vs tape measure | #27 | D | medium | metric-recon | **partial**; `valiant calibrate validate` |
| Auto-nav PD gain tuning (no oscillation) | #28 | D | high | auto-nav | **partial**; SITL + pattern flight; field tune pending |
| Side clearance calibration with real scene | #29 | D | medium | auto-nav | **partial**; field tune pending |
